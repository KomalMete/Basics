...
public interface EmployeeService {
    ...
    ByteArrayInputStream downloadListOfEmployeesFromSameCompany(Long companyId);

    ByteArrayInputStream downloadListForEmployeeAvoidOverwriteData(Long companyId);
}
